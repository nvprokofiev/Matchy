...
struct Gradients {
    ...
    private let gray = [#colorLiteral(red: 0.6000000238, green: 0.6000000238, blue: 0.6000000238, alpha: 1),#colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1)]
    
    func randomColorSet() -> TwoColorsGradient {
        
        let colors = Set([red, orangeRed, orange, yellow, green, greenBlue, kindaBlue, skyBlue, blue, bluePurple, purple, pink])
